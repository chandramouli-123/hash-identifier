> This document describes the intended architecture of Hash Identifier.
> Some components (Rich output, extended detection rules, and the full test suite)
> are planned for future releases beyond v0.1.
...
│    detail:      str         "one line description for algo  |
│                                                             │
